...
public class Library {
    ...
    public void removeBook(int elementPosition) {
        try {
            ...
            System.out.println("Book was DELETED:  " + deletedBook.getTitle());
        } catch (IndexOutOfBoundsException exceptionObject) {
            System.out.println("Please review index ! book not found: " + exceptionObject.getMessage());
        }
    }
    ...
    public void printAllTheBooks (){
        for (int i=0; i<bookList.size(); i++){
            System.out.println("The book num: " + i + " is : " + bookList.get(i).getTitle()+ "by" + bookList.get(i).getAuthor());
